...
<body>
  <main class="page">
    ...
    <section class="section">
      ...
      <p class="small">
        Programming and analytics languages used to support clinical informatics implementation, data modeling, applied clinical analytics,
        and evidence generation.
      </p>
      <ul>
        <li><strong>Python</strong>: analytics pipelines, data processing and automation, machine learning model development and evaluation, reproducible workflow execution for clinical and operational datasets.</li>
        <li><strong>R</strong>: statistical modeling, epidemiology focused analyses, reproducible research workflows, and publication ready tables and figures.</li>
        <li><strong>Stata</strong>: observational study analytics, cohort and outcomes analyses, regression modeling, and clinical research reporting workflows.</li>
      </ul>
    </section>
    ...
    <section class="section">
      ...
      <div class="item">
        ...
        <ul>
          <li>Led clinical informatics initiatives focused on practice transformation, workflow redesign, and data quality improvement in private clinical settings and consulting engagements.</li>
          <li>Designed and implemented EHR workflows, structured documentation templates, and longitudinal data capture strategies to support chronic disease management and analytics.</li>
          <li>Integrated patient generated health data from digital tools and wearables into clinical and analytic workflows to support monitoring and patient engagement.</li>
          <li>Developed applied analytics and early AI enabled decision support methods aligned with clinical usability, feasibility, and safety considerations.</li>
          <li>Owned informatics planning, implementation, evaluation, and iterative improvement to ensure operational scalability and alignment with real world clinical realities.</li>
        </ul>
      </div>
    </section>
